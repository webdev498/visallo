...
This allows plugins to adjust how list items are displayed in search results, Element Inspectors, or anywhere else the [Element List Component](../../../javascript/module-components_List.html) is used.
