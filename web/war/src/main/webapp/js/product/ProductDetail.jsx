define([
    ...
    const ProductDetail = React.createClass({
        ...
        requestComponent(props) {
            console.log('Requesting: ', props.extension.componentPath)
        ...
        componentWillReceiveProps(nextProps) {
            if (nextProps.extension.componentPath !== this.props.extension.componentPath) {
        ...
        render() {
            ...
            return (
                Component ? (<Component product={this.props.product}></Component>) : (
