...
//
//    @Test
//    public void testWorkspaceSandboxing() throws VisalloClientApiException, IOException {
//        setupTest();
...
//    }
//
//    private void setupTest() throws VisalloClientApiException, IOException {
...
//
//        ClientApiArtifactImportResponse artifact = visalloApi.getVertex().importFile("", "test.txt", new ByteArrayInputStream("Susan Feng knows Joe Ferner.".getBytes()));
...
//
//        ClientApiElement susanFengVertex = visalloApi.getVertex().create(TestOntology.CONCEPT_PERSON, "", "justification");
//        susanFengVertexId = susanFengVertex.getId();
//        visalloApi.getVertex().setProperty(susanFengVertexId, TEST_MULTI_VALUE_KEY, VisalloProperties.TITLE.getPropertyName(), "Susan Feng", "", "test");
//
//        visalloTestCluster.processGraphPropertyQueue();
//        visalloApi.getVertex().setProperty(susanFengVertexId, "key1", TestOntology.PROPERTY_NAME, "Joe", "A", "test", null, null);
//        visalloApi.getVertex().setProperty(susanFengVertexId, "key2", TestOntology.PROPERTY_NAME, "Bob", "A", "test", null, null);
//        visalloApi.getVertex().setProperty(susanFengVertexId, "key2", TestOntology.PROPERTY_NAME, "Sam", "B", "test", null, null);
//
//        assertPublishAll(visalloApi, 17);
//
//        susanFengVertex = visalloApi.getVertex().getByVertexId(susanFengVertexId);
...
//    }
//
//    private void addPropertyWithPublicChangeSandboxStatus() throws VisalloClientApiException, IOException {
//        VisalloApi visalloApi = login(USERNAME_TEST_USER_1);
//        ClientApiElement susanFengVertex = visalloApi.getVertex().setProperty(susanFengVertexId, "key1", TestOntology.PROPERTY_NAME, "Tom", "A", "test", null, null);
...
//    }
//
//    private void addPropertyWithPrivateSandboxStatus() throws VisalloClientApiException, IOException {
//        VisalloApi visalloApi = login(USERNAME_TEST_USER_1);
//        visalloApi.getVertex().setProperty(susanFengVertexId, "key2", TestOntology.PROPERTY_NAME, "Dave", "C", "test", null, null);
//        ClientApiElement susanFengVertex = visalloApi.getVertex().setProperty(susanFengVertexId, "key3", TestOntology.PROPERTY_NAME, "Susan", "", "test", null, null);
//
//        List<ClientApiProperty> key1Properties = getProperties(susanFengVertex.getProperties(), "key1", TestOntology.PROPERTY_NAME);
//        assertEquals(2, key1Properties.size());
//        assertEquals("Tom", key1Properties.get(0).getValue());
...
//    }
//
//    private void assertAllPropertiesArePublic() throws VisalloClientApiException, IOException {
//        VisalloApi visalloApi = login(USERNAME_TEST_USER_1);
//        assertPublishAll(visalloApi, 3);
//        ClientApiElement susanFengVertex = visalloApi.getVertex().getByVertexId(susanFengVertexId);
//        List<ClientApiProperty> properties = susanFengVertex.getProperties();
...
//    }
//
//    private void addEdge() throws VisalloClientApiException {
//        VisalloApi visalloApi = login(USERNAME_TEST_USER_1);
//
//        ClientApiEdgeWithVertexData edge = visalloApi.getEdge().create(artifactVertexId, susanFengVertexId, "http://visallo.org/test#artifactHasEntity", "", null);
//        visalloApi.getEdge().setProperty(edge.getId(), "key1", "http://visallo.org/test#firstName", "edge property value", "", "");
//
...
//
//        edge = visalloApi.getEdge().getByEdgeId(edge.getId());
