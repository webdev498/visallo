...
//    }
//
//    private void importVideoAndPublishAsUser1() throws VisalloClientApiException, IOException {
...
//    }
//
//    private void assertRawRoutePlayback() throws VisalloClientApiException, IOException {
//        LOGGER.info("assertRawRoutePlayback");
//        VisalloApi visalloApi = login(USERNAME_TEST_USER_1);
//
//        byte[] found = IOUtils.toByteArray(visalloApi.getVertex().getRawForPlayback(artifactVertexId, MediaVisalloProperties.MIME_TYPE_VIDEO_MP4));
//        assertTrue(found.length > 0);
//
//        visalloApi.logout();
//    }
//
//    private void assertPosterFrameRoute() throws VisalloClientApiException, IOException {
//        LOGGER.info("assertPosterFrameRoute");
//        VisalloApi visalloApi = login(USERNAME_TEST_USER_1);
//
//        InputStream in = visalloApi.getVertex().getPosterFrame(artifactVertexId, 100);
...
//    }
//
//    private void assertVideoPreviewRoute() throws IOException, VisalloClientApiException {
//        LOGGER.info("assertVideoPreviewRoute");
//        VisalloApi visalloApi = login(USERNAME_TEST_USER_1);
//
//        InputStream in = visalloApi.getVertex().getVideoPreview(artifactVertexId, 100);
//        BufferedImage img = ImageIO.read(in);
...
//    }
//
//    private void resolveTermsAsUser1() throws VisalloClientApiException {
...
//        visalloApi.getVertex().resolveVideoTranscriptTerm(artifactVertexId, propertyKey, videoFrameIndex, mentionStart, mentionEnd, "Salam", TestOntology.CONCEPT_PERSON, "auth1");
//
//        videoFrameIndex = 2;
//        mentionStart = "appalling brutality what we know is that\nthree ".length();
//        mentionEnd = mentionStart + "British".length();
//        visalloApi.getVertex().resolveVideoTranscriptTerm(artifactVertexId, propertyKey, videoFrameIndex, mentionStart, mentionEnd, "Great Britain", TestOntology.CONCEPT_PERSON, "auth1");
//
//        visalloTestCluster.processGraphPropertyQueue();
//
//        String highlightedText = visalloApi.getVertex().getHighlightedText(artifactVertexId, propertyKey);
